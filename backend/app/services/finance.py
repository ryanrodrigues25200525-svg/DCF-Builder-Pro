...
PEER_PROFILE_TIMEOUT_SECONDS = 1.5
...
async def _fetch_and_cache_market_data(normalized_ticker: str, cache_key: str) -> Dict[str, Any]:
    ...
    if not _has_usable_market_snapshot(yahoo_result):
        try:
    ...
    if result:
        ...
        ttl_seconds = MARKET_TTL_SECONDS if _has_usable_market_snapshot(result) else 90
