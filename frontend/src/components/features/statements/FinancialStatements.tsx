...
export const FinancialStatements = memo(function FinancialStatements({
    ...
    const renderConfigRows = useCallback((rows: StatementRowConfig[], headerTitle: string, headerColor: string) => (
        <>
            <tr>
                <td
                    className="sticky left-0 z-30 bg-[var(--bg-app)]/95 border-r border-[var(--border-subtle)] px-6 py-3 text-[10px] font-black uppercase tracking-[0.2em]"
    ...
    return (
        <div className="financials-theme-scope relative flex h-full overflow-hidden bg-[var(--bg-app)]" style={lightThemeVars}>
            ...
            {!isFullscreen && isSidebarOpen && !isCompactWorkspace && (
                <div className="relative z-30 h-full shrink-0 overflow-hidden border-r border-[var(--border-subtle)] bg-[var(--bg-app)]">
                ...
                {!isFullscreen && isSidebarOpen && isCompactWorkspace && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute inset-y-0 left-0 z-40 w-[min(420px,92vw)] border-r border-[var(--border-subtle)] bg-[var(--bg-app)] shadow-[0_20px_70px_rgba(0,0,0,0.35)]"
                        >
                            <ParametersSidebar
                                assumptions={assumptions}
                                results={results}
            ...
            <div className="relative z-20 flex min-w-0 flex-1 flex-col bg-transparent">
                ...
                <div className="relative flex-1 overflow-auto custom-scrollbar px-4 pb-4 lg:px-8">
                    ...
                    <div className={cn(
                        ...
                        isDarkMode ? "border-white/8 bg-white/[0.02]" : "border-[rgba(15,23,42,0.08)] bg-[rgba(248,250,252,0.8)]"
                    )}>
                        <div>
                            ...
                            <p className={cn("mt-1 text-[14px] font-bold", isDarkMode ? "text-white" : "text-[var(--text-primary)]")}>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <span className={cn(
                                ...
                                isDarkMode ? "bg-white/[0.05] text-white/68" : "bg-[rgba(15,23,42,0.05)] text-[rgba(15,23,42,0.58)]"
                            )}>
                                    ...
                                    return (
                                        <th key={year} className={cn(
                                            ...
                                            <div className="flex flex-col items-end gap-1.5">
                                                <span className="font-display text-[15px] font-black tracking-tight text-[var(--text-primary)]">
                                                    FY{year}
                                                </span>
                                                <div className={cn(
                                ...
                                balanceRows.length > 0 ? (
                                    ...
                                    <NativeStatementTable rows={balanceRows} years={displayedYears} foreYears={foreYears} headerTitle="Balance Sheet" headerColor="#AF52DE" statementKind="balance" displayMode={displayMode} valueScale={valueScale} getForecastValueForRow={getForecastValueForNativeRow} />
                                        <tr className="bg-[var(--bg-glass)]">
                                            <td className="p-5 sticky left-0 z-30 bg-[var(--bg-card)] border-r border-[var(--border-subtle)] border-t border-[var(--border-subtle)] whitespace-nowrap">
                                                <span className="text-[13px] font-bold text-[var(--text-secondary)] uppercase tracking-wider">Balance Check</span>
                                            </td>
                                            {displayedYears.map((year) => {
                                                ...
                                                return (
                                                    <td key={year} className="p-5 text-right border-t border-[var(--border-subtle)]">
                                                        <span className={cn(
